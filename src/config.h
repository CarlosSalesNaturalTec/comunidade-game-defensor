...
// ── Parâmetros de Jogo ────────────────────────────────
#define HP_MAXIMO          5    // pontos de energia do escudo (1 LED = 1 ponto)
#define TEMPO_RECARGA_MS   4000 // tempo de recarga em ms — 4 segundos
#define DEBOUNCE_HIT_MS    350  // intervalo mínimo entre dois hits (ms)
                                // muito baixo → hit duplo | muito alto → hit perdido
